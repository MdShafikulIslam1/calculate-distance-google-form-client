...
const ReservationForm = () => {
  const reservation = useAppSelector((state) => state.route);
      ...
      >
        ...
        <div className="space-x-2">
          ...
          <label htmlFor="termsAndCondition">
            ...
            <span className="text-[#FCB040]">I agree</span> that my information
            will be used only for the purpose of my reservation.
          </label>
